...
export const OptionDrawers = ({ className }: { className?: string }) => {
    ...
    return (
        <div
            className={cn(
                "flex justify-end gap-2 max-[412px]:!mb-4 max-[640px]:overflow-x-auto max-[640px]:w-[min(320px,calc(100vw-5rem))] max-[640px]:justify-start max-[640px]:[&>button]:flex-shrink-0 max-[640px]:[&>div]:flex-shrink-0 max-[640px]:pb-1",
                className,
            )}
        >
            <input
